...
urlpatterns = [
    ...
    path('dashboard/', views.dashboard_view, name='dashboard'),    path("manage-variants/<int:product_id>/", views.manage_variants, name="manage_variants"),    path("update-product/<int:product_id>/", views.update_product, name="update_product"),
